//not forgot about settings.gradle.kts
object LocalGradleProjects {
    ...
    const val coreApiStagingTools = ":core_api_staging_tools"

    const val coreApiTestUtils = ":core_api_test_utils"

    const val androidCoreApi = ":android_core_api"

    const val testUtils = ":test_utils"

    const val parsingImpl = ":parsing_impl"

    const val networkApi = ":network_api"
    const val networkImpl = ":network_impl"
    ...
    const val coreImplStagingTools = ":core_impl_staging_tools"

    const val coreUiApi = ":core_ui_api"

    const val coreUiApiTestUtils = ":core_ui_api_test_utils"

    const val coreUiImpl = ":core_ui_impl"
    ...
    const val gameStorageImpl = ":game_storage_impl"

    const val gamePlayUi = ":game_play_ui"

    const val gameSettingsUi = ":game_settings_ui"

    const val gameTopImpl = ":game_top_impl"
    const val gameTopUi = ":game_top_ui"
}