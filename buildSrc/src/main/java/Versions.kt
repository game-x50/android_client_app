...
object Versions {
    ...
    const val crashlyticsPluginVersion = "2.7.1"

    const val detektVersion = "1.17.1"
    const val androidJarPluginVersion = "0.1"

    const val dependencyAnalysisPluginVersion = "0.75.0"
    ...
    const val dagger2Version = "2.38"

    const val firebaseBomVersion = "28.2.1"

    const val supportAppCompatVersion = "1.3.1"
    const val supportDesignVersion = "1.4.0"
