...
import com.ruslan.hlushan.game.play.ui.view.calculations.GameViewDimensions
...
class GameViewDimensionsTest {
    ...
    @Test
    fun equality() = assertDifferentParams { gameViewDimensions1, tableViewSizeWithoutSums, usingViewHeight, usingViewWidth,
                                             horizontalNonUsingSpace, verticalNonUsingSpace, cellSizeWithoutLines ->
        val gameViewDimensions2 = GameViewDimensions(tableViewSizeWithoutSums = tableViewSizeWithoutSums,
    ...
    @Test
    fun createDefault() =
            assertEquals(GameViewDimensions(tableViewSizeWithoutSums = 0,
                                            usingViewHeight = 0,
                                            usingViewWidth = 0,
    ...
    @Test
    fun leftRightNonUsingPadding() = assertDifferentParams { gameViewDimensions, tableViewSizeWithoutSums, usingViewHeight, usingViewWidth,
                                                             horizontalNonUsingSpace, verticalNonUsingSpace, cellSizeWithoutLines ->
    ...
    @Test
    fun topBottomNonUsingPadding() = assertDifferentParams { gameViewDimensions, tableViewSizeWithoutSums, usingViewHeight, usingViewWidth,
                                                             horizontalNonUsingSpace, verticalNonUsingSpace, cellSizeWithoutLines ->
    ...
    @Test
    fun tableViewSizeWithSumsAndLines() = assertDifferentParams { gameViewDimensions, tableViewSizeWithoutSums, usingViewHeight, usingViewWidth,
                                                                  horizontalNonUsingSpace, verticalNonUsingSpace, cellSizeWithoutLines ->
                    ...
                    for (horizontalNonUsingSpace in 0..100 step 10) {
                        for (verticalNonUsingSpace in 0..100 step 10) {
                            for (cellSizeWithoutLines in 0..100 step 10) {
                                val gameViewDimensions = GameViewDimensions(tableViewSizeWithoutSums = tableViewSizeWithoutSums,
                                                                            usingViewHeight = usingViewHeight,
                                                                            usingViewWidth = usingViewWidth,
                                                                            horizontalNonUsingSpace = horizontalNonUsingSpace,
                                                                            verticalNonUsingSpace = verticalNonUsingSpace,
