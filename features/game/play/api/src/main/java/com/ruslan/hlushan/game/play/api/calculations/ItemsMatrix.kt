...
import com.ruslan.hlushan.game.play.api.containsInclusive
import com.ruslan.hlushan.game.play.api.convertToFake
...
val ItemsMatrix.notFakeItems: List<RectangleArea> get() = this.items.filter { area -> !area.isFake }
...
fun ItemsMatrix.getRow(row: Int): List<RectangleArea> =
...
fun ItemsMatrix.getColumn(column: Int): List<RectangleArea> =
